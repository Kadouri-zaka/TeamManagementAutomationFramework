...
public class AddNewBR {
    ...
    String bussnissRequestInformaation[] = {"ZakaTest01/04/22_3","CASIS Lot 1","AGRI","Project in Progress (PiP)","TM","Initial"};
    ...
    public void user_add_a_request_number_framework_contract_department_status_service_type_source()  {
        ...
        commonHelper.waitElementToBeClickable(By.name("DGdepartment")).sendKeys(bussnissRequestInformaation[2]);
        commonHelper.selectText(bussnissRequestInformaation[3],By.name("status"));
        commonHelper.selectText(bussnissRequestInformaation[4],By.name("typebr"));
        commonHelper.selectText(bussnissRequestInformaation[5],By.id("SourceBusinessRq"));
    }
